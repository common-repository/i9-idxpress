...
/*
Plugin Name: IDXMATRIX
Plugin URI: https://magnisplus.com/
Description: An MagnisPlus word-press plugin to embed live real estate data from an MLS directly into a blog. You must have a IDXMATRIX account to use this plugin.
Author: MagnisPlus
Version: 1.0
Author URI: http://magnisplus.com/
*/
...
wp_enqueue_style('i9_admin_options_style', plugins_url('css/admin-options.css', __FILE__ ), array(), i9_PLUGIN_VERSION);
