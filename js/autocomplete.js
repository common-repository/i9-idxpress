jQuery().ready(function($) {
	...
	$('.i9_panels').click(function(e) {
		...
		if($(this).attr('data-panel')=="expanded"){
			$('.featured-listing').show();
				$("#pan-det").css("background-color", "#31708f");
		...
		if($(this).attr('data-panel')=="list"){
			...
			$('.small-listing').show();
				$("#pan-li").css("background-color", "#31708f");
		...
		if($(this).attr('data-panel')=="slideshow"){
			...
			$('.slide-listing').show();
				$("#pan-sli").css("background-color", "#31708f");
		...
		if($(this).attr('data-panel')=="map"){
			...
			$('#listingMap2').show();
				$("#pan-map").css("background-color", "#31708f");
	...
	$('#listb').click(function(){
		localStorage.resultIDXflag = 2;
		$("#mapb").css("background-color", "#FFFFFF");		
		$("#groupb").css("background-color", "#FFFFFF");
		$('#listb').css("background-color", "#BDBDBD");
		$('#maping').hide();
		$('#listview').show();
		$('#gridview').hide();
	})
	$('#groupb').click(function(e) {
		localStorage.resultIDXflag = 1;
		$('#listb').css("background-color", "#FFFFFF");
		$("#mapb").css("background-color", "#FFFFFF");		
	...
	if(typeof localStorage.resultIDXflag !== 'undefined'){
		if(localStorage.resultIDXflag && localStorage.resultIDXflag == 2){
			$('#listb').trigger('click');
		} else if (localStorage.resultIDXflag && localStorage.resultIDXflag == 3) {
			$('#mapb').trigger('click');
		} else {
			$('#groupb').trigger('click');
		}
	} else {
		$('#groupb').trigger('click');
	}
	...
	function calc(){
		$('#cal_err').html('');
		if(!$.isNumeric($('#intrate').val()) || $('#intrate').val()>100){ $('#cal_err').html('Please Enter Interest Rate'); return false;}
		if(!$.isNumeric($('#cprice').val())){ $('#cal_err').html('Please Enter Correct Price'); return false;}
		if(!$.isNumeric($('#downpay').val()) || $('#downpay').val()>100){ $('#cal_err').html('Please Enter Correct Downpay'); return false;}
		if(!$.isNumeric($('#esttax').val()) || $('#esttax').val()>100){ $('#cal_err').html('Please Enter Correct Est.Tax Rate'); return false;}
	...
	function listingmap(x){
		...
		if(x=='1'){
			...
			map.setOptions({ minZoom: 6, maxZoom: 28 });
